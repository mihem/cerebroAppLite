...
# with following call:
# >rix(r_ver = "393d781d78e39df597df37773f8ae73c2a5e8044",
#  > r_pkgs = c("devtools",
#  > "testthat",
#  > "pkgdown",
#  > "shinytest2",
...
#  > project_path = ".",
#  > overwrite = TRUE)
# It uses upstream nixpkgs' revision 393d781d78e39df597df37773f8ae73c2a5e8044 for reproducibility purposes
# which will install R version latest-upstream.
# Report any issues to https://github.com/ropensci/rix
let
 pkgs = import (fetchTarball "https://github.com/NixOS/nixpkgs/archive/393d781d78e39df597df37773f8ae73c2a5e8044.tar.gz") {};
