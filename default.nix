...
# with following call:
# >rix(r_ver = "e738fea84691780c5b123f7620dbc7e558b9a5e4",
#  > r_pkgs = c("devtools",
#  > "testthat",
#  > "pkgdown",
#  > "shinytest2",
...
#  > project_path = ".",
#  > overwrite = TRUE)
# It uses upstream nixpkgs' revision e738fea84691780c5b123f7620dbc7e558b9a5e4 for reproducibility purposes
# which will install R version latest-upstream.
# Report any issues to https://github.com/ropensci/rix
let
 pkgs = import (fetchTarball "https://github.com/NixOS/nixpkgs/archive/e738fea84691780c5b123f7620dbc7e558b9a5e4.tar.gz") {};
