# This file was generated by the {rix} R package v0.18.2 on 2026-06-30
# with following call:
...
let
 pkgs = import (fetchTarball "https://github.com/rstats-on-nix/nixpkgs/archive/2026-06-15.tar.gz") {};
