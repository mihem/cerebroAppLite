...
# with following call:
# >rix(r_ver = "68f4bc59cfbcdbe6998b070da7ff277858c546f4",
#  > r_pkgs = c("devtools",
#  > "testthat",
#  > "pkgdown",
#  > "shinytest2",
...
#  > project_path = ".",
#  > overwrite = TRUE)
# It uses upstream nixpkgs' revision 68f4bc59cfbcdbe6998b070da7ff277858c546f4 for reproducibility purposes
# which will install R version latest-upstream.
# Report any issues to https://github.com/ropensci/rix
let
 pkgs = import (fetchTarball "https://github.com/NixOS/nixpkgs/archive/68f4bc59cfbcdbe6998b070da7ff277858c546f4.tar.gz") {};
