...
# with following call:
# >rix(r_ver = "ff4630523dad44f3767696baff655fc9e70576bd",
#  > r_pkgs = c("devtools",
#  > "testthat",
#  > "shinytest2",
#  > "shinyvalidate",
...
#  > project_path = ".",
#  > overwrite = TRUE)
# It uses upstream nixpkgs' revision ff4630523dad44f3767696baff655fc9e70576bd for reproducibility purposes
# which will install R version latest-upstream.
# Report any issues to https://github.com/ropensci/rix
let
 pkgs = import (fetchTarball "https://github.com/NixOS/nixpkgs/archive/ff4630523dad44f3767696baff655fc9e70576bd.tar.gz") {};
