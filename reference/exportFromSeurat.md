...
#> [07:17:52] Initializing Cerebro object...
#> [07:17:52] Adding expression data (embedded)...
#> [07:17:52] Collecting available meta data...
#> [07:17:52] Extracting all meta data columns...
#> [07:17:52] Extracting dimensional reductions...
#> [07:17:52] Will export the following dimensional reductions: umap
#> [07:17:52] Checking for spatial data...
#> [07:17:52] Extracting marker genes table...
#> [07:17:52] No trajectories to extract...
#> [07:17:52] Overview of Cerebro object:
#> class: Cerebro_v1.3
#> cerebroApp version: 1.7.0
#> experiment name: PBMC
#> organism: hg
#> date of analysis: 
#> date of export: 2026-05-31
#> number of cells: 80
#> number of genes: 230
...
#> Immune repertoire:
#> Spatial data:
#> [07:17:52] Saving Cerebro object to: /tmp/nix-shell-4545-1862054685/RtmpnJbGsG/pbmc_Seurat.crb
#> [07:17:52] Done!
```
