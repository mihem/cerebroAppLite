...
#> [19:57:48] Initializing Cerebro object...
#> [19:57:48] Adding expression data (embedded)...
#> [19:57:48] Collecting available meta data...
#> [19:57:48] Extracting all meta data columns...
#> [19:57:48] Extracting dimensional reductions...
#> [19:57:48] Will export the following dimensional reductions: umap
#> [19:57:48] Extracting marker genes table...
#> [19:57:48] No trajectories to extract...
#> [19:57:48] Overview of Cerebro object:
#> class: Cerebro_v1.3
#> cerebroApp version: 1.7.4
#> experiment name: PBMC
#> organism: hg
#> date of analysis: 
#> date of export: 2026-07-05
#> number of cells: 80
#> number of genes: 230
...
#> extra material:
#> Immune repertoire:
#> [19:57:48] Saving Cerebro object to: /tmp/nix-shell-4136-2492305821/RtmpqI8eB2/pbmc_Seurat.crb
#> [19:57:48] Done!
```
