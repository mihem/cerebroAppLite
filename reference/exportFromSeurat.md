...
#> [06:10:46] Initializing Cerebro object...
#> [06:10:46] Adding expression data (embedded)...
#> [06:10:46] Collecting available meta data...
#> [06:10:46] Extracting all meta data columns...
#> [06:10:46] Extracting dimensional reductions...
#> [06:10:46] Will export the following dimensional reductions: umap
#> [06:10:46] Extracting marker genes table...
#> [06:10:46] No trajectories to extract...
#> [06:10:46] Overview of Cerebro object:
#> class: Cerebro_v1.3
#> cerebroApp version: 1.7.4
#> experiment name: PBMC
#> organism: hg
#> date of analysis: 
#> date of export: 2026-07-01
#> number of cells: 80
#> number of genes: 230
...
#> extra material:
#> Immune repertoire:
#> [06:10:46] Saving Cerebro object to: /tmp/nix-shell-4382-3366161992/RtmpfmdRgw/pbmc_Seurat.crb
#> [06:10:46] Done!
```
