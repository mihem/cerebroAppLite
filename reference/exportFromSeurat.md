...
#> [11:50:14] Initializing Cerebro object...
#> [11:50:14] Adding expression data (embedded)...
#> [11:50:14] Collecting available meta data...
#> [11:50:14] Extracting all meta data columns...
#> [11:50:14] Extracting dimensional reductions...
#> [11:50:14] Will export the following dimensional reductions: umap
#> [11:50:14] Extracting marker genes table...
#> [11:50:14] No trajectories to extract...
#> [11:50:14] Checking for spatial data...
#> [11:50:14] Overview of Cerebro object:
#> class: Cerebro_v1.3
#> cerebroApp version: 3.0.0
#> experiment name: PBMC
#> organism: hg
#> date of analysis: 
#> date of export: 2026-07-23
#> number of cells: 80
#> number of genes: 230
...
#> HLA typing: none
#> Spatial data:
#> [11:50:14] Saving Cerebro object to: /tmp/nix-shell-4307-3884229591/RtmpZuOOSL/pbmc_Seurat.crb
#> [11:50:14] Done!
```
