...
#> [12:10:59] Initializing Cerebro object...
#> [12:10:59] Adding expression data (embedded)...
#> [12:10:59] Collecting available meta data...
#> [12:10:59] Extracting all meta data columns...
#> [12:10:59] Extracting dimensional reductions...
#> [12:10:59] Will export the following dimensional reductions: umap
#> [12:10:59] Extracting marker genes table...
#> [12:10:59] No trajectories to extract...
#> [12:10:59] Overview of Cerebro object:
#> class: Cerebro_v1.3
#> cerebroApp version: 1.7.3
#> experiment name: PBMC
#> organism: hg
#> date of analysis: 
#> date of export: 2026-06-27
#> number of cells: 80
#> number of genes: 230
...
#> extra material:
#> Immune repertoire:
#> [12:10:59] Saving Cerebro object to: /tmp/nix-shell-4531-862073568/Rtmp865I20/pbmc_Seurat.crb
#> [12:10:59] Done!
```
