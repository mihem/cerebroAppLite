...
#> [20:29:20] Initializing Cerebro object...
#> [20:29:20] Adding expression data (embedded)...
#> [20:29:20] Collecting available meta data...
#> [20:29:20] Extracting all meta data columns...
#> [20:29:20] Extracting dimensional reductions...
#> [20:29:20] Will export the following dimensional reductions: umap
#> [20:29:20] Extracting marker genes table...
#> [20:29:20] No trajectories to extract...
#> [20:29:20] Overview of Cerebro object:
#> class: Cerebro_v1.3
#> cerebroApp version: 1.7.4
#> experiment name: PBMC
#> organism: hg
#> date of analysis: 
#> date of export: 2026-06-30
#> number of cells: 80
#> number of genes: 230
...
#> extra material:
#> Immune repertoire:
#> [20:29:20] Saving Cerebro object to: /tmp/nix-shell-4301-3335674726/RtmpP3f4BY/pbmc_Seurat.crb
#> [20:29:20] Done!
```
