...
#> [15:15:14] Initializing Cerebro object...
#> [15:15:14] Adding expression data (embedded)...
#> [15:15:14] Collecting available meta data...
#> [15:15:14] Extracting all meta data columns...
#> [15:15:14] Extracting dimensional reductions...
#> [15:15:14] Will export the following dimensional reductions: umap
#> [15:15:14] Extracting marker genes table...
#> [15:15:14] No trajectories to extract...
#> [15:15:14] Overview of Cerebro object:
#> class: Cerebro_v1.3
#> cerebroApp version: 1.7.2
#> experiment name: PBMC
#> organism: hg
#> date of analysis: 
#> date of export: 2026-06-15
#> number of cells: 80
#> number of genes: 230
...
#> extra material:
#> Immune repertoire:
#> [15:15:14] Saving Cerebro object to: /tmp/nix-shell-4529-2550891682/RtmpggGI1C/pbmc_Seurat.crb
#> [15:15:14] Done!
```
