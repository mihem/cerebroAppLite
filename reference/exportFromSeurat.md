...
#> [06:41:21] Initializing Cerebro object...
#> [06:41:21] Collecting available meta data...
#> [06:41:21] Extracting all meta data columns...
#> [06:41:21] Extracting dimensional reductions...
#> [06:41:21] Will export the following dimensional reductions: umap
#> [06:41:21] Extracting tables of marker genes...
#> [06:41:21] No trajectories to extract...
#> [06:41:21] Overview of Cerebro object:
#> class: Cerebro_v1.3
#> cerebroApp version: 1.6.0
#> experiment name: PBMC
#> organism: hg
#> date of analysis: 
#> date of export: 2026-05-17
#> number of cells: 80
#> number of genes: 230
...
#> trajectories:
#> extra material:
#> [06:41:21] Saving Cerebro object to: /tmp/nix-shell-4596-1653762555/RtmpqyKdKJ/pbmc_Seurat.crb
#> [06:41:21] Done!
```
