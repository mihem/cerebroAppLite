...
#> [08:16:22] Initializing Cerebro object...
#> [08:16:22] Adding expression data (embedded)...
#> [08:16:22] Collecting available meta data...
#> [08:16:22] Extracting all meta data columns...
#> [08:16:22] Extracting dimensional reductions...
#> [08:16:22] Will export the following dimensional reductions: umap
#> [08:16:22] Checking for spatial data...
#> [08:16:22] Extracting marker genes table...
#> [08:16:22] No trajectories to extract...
#> [08:16:22] Overview of Cerebro object:
#> class: Cerebro_v1.3
#> cerebroApp version: 1.7.0
#> experiment name: PBMC
#> organism: hg
#> date of analysis: 
#> date of export: 2026-06-07
#> number of cells: 80
#> number of genes: 230
...
#> Immune repertoire:
#> Spatial data:
#> [08:16:22] Saving Cerebro object to: /tmp/nix-shell-4644-2629710982/Rtmp1lwTQr/pbmc_Seurat.crb
#> [08:16:22] Done!
```
