...
#> [09:03:56] Initializing Cerebro object...
#> [09:03:56] Adding expression data (embedded)...
#> [09:03:56] Collecting available meta data...
#> [09:03:56] Extracting all meta data columns...
#> [09:03:56] Extracting dimensional reductions...
#> [09:03:56] Will export the following dimensional reductions: umap
#> [09:03:56] Extracting marker genes table...
#> [09:03:56] No trajectories to extract...
#> [09:03:56] Overview of Cerebro object:
#> class: Cerebro_v1.3
#> cerebroApp version: 1.7.4
#> experiment name: PBMC
#> organism: hg
#> date of analysis: 
#> date of export: 2026-07-06
#> number of cells: 80
#> number of genes: 230
...
#> extra material:
#> Immune repertoire:
#> [09:03:56] Saving Cerebro object to: /tmp/nix-shell-4289-3458920155/RtmpKpflSz/pbmc_Seurat.crb
#> [09:03:56] Done!
```
