...
#> [18:40:00] Initializing Cerebro object...
#> [18:40:00] Adding expression data (embedded)...
#> [18:40:00] Collecting available meta data...
#> [18:40:00] Extracting all meta data columns...
#> [18:40:00] Extracting dimensional reductions...
#> [18:40:00] Will export the following dimensional reductions: umap
#> [18:40:00] Extracting marker genes table...
#> [18:40:00] No trajectories to extract...
#> [18:40:00] Overview of Cerebro object:
#> class: Cerebro_v1.3
#> cerebroApp version: 1.7.1
#> experiment name: PBMC
#> organism: hg
#> date of analysis: 
#> date of export: 2026-06-14
#> number of cells: 80
#> number of genes: 230
...
#> extra material:
#> Immune repertoire:
#> [18:40:00] Saving Cerebro object to: /tmp/nix-shell-4612-2666651101/Rtmpuss4aD/pbmc_Seurat.crb
#> [18:40:00] Done!
```
