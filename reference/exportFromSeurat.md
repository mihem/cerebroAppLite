...
#> [15:48:48] Initializing Cerebro object...
#> [15:48:48] Adding expression data (embedded)...
#> [15:48:48] Collecting available meta data...
#> [15:48:48] Extracting all meta data columns...
#> [15:48:48] Extracting dimensional reductions...
#> [15:48:48] Will export the following dimensional reductions: umap
#> [15:48:48] Extracting marker genes table...
#> [15:48:48] No trajectories to extract...
#> [15:48:48] Overview of Cerebro object:
#> class: Cerebro_v1.3
#> cerebroApp version: 1.7.2
#> experiment name: PBMC
#> organism: hg
#> date of analysis: 
#> date of export: 2026-06-16
#> number of cells: 80
#> number of genes: 230
...
#> extra material:
#> Immune repertoire:
#> [15:48:48] Saving Cerebro object to: /tmp/nix-shell-4590-2578490491/RtmpUhzl6m/pbmc_Seurat.crb
#> [15:48:48] Done!
```
