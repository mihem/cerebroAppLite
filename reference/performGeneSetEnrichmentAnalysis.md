...
#> [14:57:47] Loading gene sets...
#> [14:57:47] Loaded 2 gene sets from GMT file.
#> [14:57:47] Extracting transcript counts from `data` slot of `RNA` assay...
#> [14:57:47] Performing analysis for 2 subgroups of group `sample`...
#> ℹ GSVA version 2.4.7
...
#> [14:57:47] 0 gene sets passed the thresholds across all subgroups of group `sample`.
#> [14:57:47] Performing analysis for 2 subgroups of group `seurat_clusters`...
#> ℹ GSVA version 2.4.7
#> ℹ Searching for rows with constant values
#> ℹ Calculating GSVA ranks
#> ℹ kcdf='auto' (default)
...
#> ℹ Calculating GSVA scores
#> ✔ Calculations finished
#> [14:57:48] 0 gene sets passed the thresholds across all subgroups of group `seurat_clusters`.
```
