...
#> [05:37:16] Loading gene sets...
#> [05:37:16] Loaded 2 gene sets from GMT file.
#> [05:37:16] Extracting transcript counts from `data` slot of `RNA` assay...
#> [05:37:16] Performing analysis for 2 subgroups of group `sample`...
...
#> [05:37:16] 0 gene sets passed the thresholds across all subgroups of group `sample`.
#> [05:37:16] Performing analysis for 2 subgroups of group `seurat_clusters`...
#> ℹ GSVA version 2.6.2
#> ℹ Searching for rows with constant values
#> ℹ Calculating GSVA ranks
#> ℹ kcdf='auto' (default)
...
#> ℹ Calculating GSVA scores for 2 gene sets
#> ✔ Calculations finished
#> [05:37:17] 0 gene sets passed the thresholds across all subgroups of group `seurat_clusters`.
```
