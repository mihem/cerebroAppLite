...
#> [19:56:37] Loading gene sets...
#> [19:56:37] Loaded 2 gene sets from GMT file.
#> [19:56:37] Extracting transcript counts from `data` slot of `RNA` assay...
#> [19:56:37] Performing analysis for 2 subgroups of group `sample`...
...
#> [19:56:37] 0 gene sets passed the thresholds across all subgroups of group `sample`.
#> [19:56:37] Performing analysis for 2 subgroups of group `seurat_clusters`...
#> ℹ GSVA version 2.6.1
#> ℹ Searching for rows with constant values
#> ℹ Calculating GSVA ranks
#> ℹ kcdf='auto' (default)
...
#> ℹ Calculating GSVA scores for 2 gene sets
#> ✔ Calculations finished
#> [19:56:37] 0 gene sets passed the thresholds across all subgroups of group `seurat_clusters`.
```
