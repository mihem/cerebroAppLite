...
#> [16:01:13] Loading gene sets...
#> [16:01:13] Loaded 2 gene sets from GMT file.
#> [16:01:13] Extracting transcript counts from `data` slot of `RNA` assay...
#> [16:01:13] Performing analysis for 2 subgroups of group `sample`...
...
#> [16:01:13] 0 gene sets passed the thresholds across all subgroups of group `sample`.
#> [16:01:13] Performing analysis for 2 subgroups of group `seurat_clusters`...
#> ℹ GSVA version 2.6.2
#> ℹ Searching for rows with constant values
#> ℹ Calculating GSVA ranks
#> ℹ kcdf='auto' (default)
...
#> ℹ Calculating GSVA scores for 2 gene sets
#> ✔ Calculations finished
#> [16:01:14] 0 gene sets passed the thresholds across all subgroups of group `seurat_clusters`.
```
