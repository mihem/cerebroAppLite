...
#> [21:20:15] Loading gene sets...
#> [21:20:15] Loaded 2 gene sets from GMT file.
#> [21:20:15] Extracting transcript counts from `data` slot of `RNA` assay...
#> [21:20:15] Performing analysis for 2 subgroups of group `sample`...
...
#> [21:20:15] 0 gene sets passed the thresholds across all subgroups of group `sample`.
#> [21:20:15] Performing analysis for 2 subgroups of group `seurat_clusters`...
#> ℹ GSVA version 2.6.1
#> ℹ Searching for rows with constant values
#> ℹ Calculating GSVA ranks
#> ℹ kcdf='auto' (default)
...
#> ℹ Calculating GSVA scores for 2 gene sets
#> ✔ Calculations finished
#> [21:20:15] 0 gene sets passed the thresholds across all subgroups of group `seurat_clusters`.
```
