...
The introduction of the `Cerebro` class is an attempt to formalize the data structure and thereby provide stability in future releases, ultimately aiming to improve backwards compatibility between Cerebro version.
