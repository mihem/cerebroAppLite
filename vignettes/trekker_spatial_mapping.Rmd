---
title: "Trekker single-cell spatial mapping: from a vendor bundle to an interactive app"
author: "Xuesong Wang"
...
output:
  html_document:
    ...
    mode: selfcontained
vignette: >
  %\VignetteIndexEntry{Trekker single-cell spatial mapping: from a vendor bundle to an interactive app}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
resource_files:
  - img/trekker_overview.png
  - img/trekker_gene.png
  - img/trekker_data_qc.png
---
...
**The Trekker demo is real measured data** — down-sampled, but not invented. So
this guide is also, unavoidably, a guide to reading it honestly: where the
coordinates really live, what "confidently positioned" does and does not mean,
and which numbers are the vendor's rather than Cerebro's.
...
the in-tree CerebroNexus (for the new `trekker` slot on `Cerebro_v1.3`).
...
<img src="img/trekker_overview.png" width="100%" alt="Trekker page: dual spatial and UMAP panes coloured by cell type" />
...
<img src="img/trekker_gene.png" width="100%" alt="Trekker page coloured by Plp1 expression" />
...
<img src="img/trekker_data_qc.png" width="100%" alt="Trekker page Data and QC, positioning evidence, and Moran's I" />
