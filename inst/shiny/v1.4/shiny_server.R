...
server <- function(input, output, session) {
  ...
  ##--------------------------------------------------------------------------##
  ## Dynamic sidebar infrastructure (insertConditionalTab, module sourcing
  ## loops, and placeholder anchors) is added in PR2 together with the first
  ## enhanced modules. The old renderMenu + toggleElement pattern for
  ## trajectory and extra_material has been removed here as dead code.
  ##--------------------------------------------------------------------------##
