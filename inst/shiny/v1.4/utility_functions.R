...
## NOTE: the .crb loading helpers (read_cerebro_file / get_or_load_crb /
## .attachExternalExpression) moved to data_loading.R and are sourced at
## process level from shiny_server.R (A4: one shared .crb_cache).
