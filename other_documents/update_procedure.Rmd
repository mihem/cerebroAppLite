...
**Creation of standalone version is currently suspended because the internal R version is too old and I haven't been able to update it.**

- Create new branch from `develop` branch, e.g. `v1.4`
